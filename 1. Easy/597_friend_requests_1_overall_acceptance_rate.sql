...
-- My Answer 
SELECT IFNULL(ROUND(COUNT(DISTINCT CONCAT(RA.requester_id, RA.accepter_id))/(SELECT COUNT(DISTINCT CONCAT(sender_id, send_to_id)) FROM FriendRequest FR), 2), 0) accept_rate

...
FROM
(SELECT stock_name, CASE WHEN operation='Buy' THEN price ELSE 0 END AS Buy, 
CASE WHEN operation='Sell' THEN price ELSE 0 END AS Sell
FROM Stocks) as operation_pivot
GROUP BY stock_name
